					...
					<div class="container">
						<div class="row mb-xl">
							...
							<div class="col-md-4 col-md-offset-1">
								...
								<p class="mt-lg"><?php echo substr($hakkimizdacek['hakkimizda_misyon'],0,400);?></p>
							</div>
                                                    <?php } else {?>
                                                    <div class="col-md-4 col-md-offset-1">
				...
				<div class="container">
					...
					<div class="row mt-xl">
						...
						<div class="col-md-6">
                            ...
                            <p class="font-size-md"><?php echo substr($icerikcek['icerik_detay'],0,250);?>...</p><br><hr>
				...
				<section class="section section-background section-footer" style="background-image: ; background-position: 50% 100%;">
					<div class="container">
						<div class="row">
							<div class="col-md-6 col-md-offset-6">
								<h2 class="mt-xl mb-none">Bize Ulaşın</h2>
								<p>İrtibata geçmek için iletişim formunu kullanabilirsiniz.</p>
								<div class="divider divider-primary divider-small mb-xl">
									<hr>
								</div>
								<form id="contactForm" action="php/contact-form.php" method="POST">
									...
									<div class="row">
										<div class="form-group">
											<div class="col-sm-6">
												<input type="text" value="" placeholder="Ad Soyad" data-msg-required="Lütfen isminizi giriniz." maxlength="100" class="form-control" name="name" id="name" required>
											</div>
											<div class="col-sm-6">
												<input type="email" value="" placeholder=" email address " data-msg-required="Please enter your email address." data-msg-email="Please enter a valid email address." maxlength="100" class="form-control" name="email" id="email" required>
											</div>
										</div>
									</div>
