...
'authors'=>$_POST['ayar_author']
 ));

if ($update) {


	echo "Güncelleme basarı ile tamamlandı";
...
if (isset($_POST['icerikkaydet'])) {
  ...
  $uploads_dir = '../../dimg/icerik'; // resmin nereye kaydedileceğini söylüyor.
  @$tmp_name = $_FILES['icerik_resimyol']["tmp_name"];
  @$name = $_FILES['icerik_resimyol']["name"];
  $benzersizsayi1=rand(20000,32000); // benzersiz sayı oluşturma
  $benzersizsayi2=rand(20000,32000);
  $benzersizsayi3=rand(20000,32000);
  $benzersizsayi4=rand(20000,32000);
  $benzersizad=$benzersizsayi1.$benzersizsayi2.$benzersizsayi3.$benzersizsayi4;
