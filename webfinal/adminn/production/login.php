        ...
        <div class="animate form login_form">
          <section class="login_content">
            <form action="../netting/islem.php" method="POST">
              ...
              <div>
               <button style="width: 100%; background-color:#73879C; color:white" type="submit" name="loggin" class="btn btn-default">Giris Yap</button>
              ...
              <div class="separator">
                ...
                <div>
                  <h1><i class="fa fa-paw"></i> Ali Tüzün</h1>
                  <p>©2017 Ali tüzün Tarafından Kodlanmıştır</p>
                </div>
              </div>
            </form>
          </section>
