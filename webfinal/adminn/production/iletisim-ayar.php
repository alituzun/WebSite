                  ...
                  <div class="x_content">
                   ...
                   <form action="../netting/islem.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          value="<?php  echo $ayarcek['ayar_gsm'];  ?>" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>  
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          value="<?php  echo $ayarcek['ayar_faks'];  ?>" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          value="<?php  echo $ayarcek['ayar_mail'];  ?>" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>

                                         <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Adres Bilgileriniz <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          value="<?php  echo $ayarcek['ayar_ilce'];  ?>" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          value="<?php  echo $ayarcek['ayar_il'];  ?>" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
